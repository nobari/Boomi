...
var getIcCity = function getIcCity(codeMelli) {
    var e = codeMelli.substr(0, 3);
...
var postalCode = function postalCode(input) {
    return /^(\d{5}-?\d{5})$/.test(input);
};
/*********************************************************
...
var sheba = function sheba(input) {
    ...
    if (input) {
        ...
        if (input.length < 4 || input.length > 34 || !isNaN(input[0]) || !isNaN(input[1]) || isNaN(input[2]) || isNaN(input[3])) {
            return false;
        }
...
var melliCode = function melliCode(input) {
...
var validSheba = function validSheba(str) {
...
var getSheba = function getSheba(str) {
    if (!str || typeof str != "string") return;
    if (!str.startsWith("IR")) str = "IR" + str;
...
var prettyStringify = function prettyStringify(obj) {
    var cache = [];
...
var dragElement = function dragElement(elmnt) {
    var pos1 = 0,
        ...
        pos3 = 0,
        pos4 = 0;
    var clearer = elmnt.querySelector(".header .clearer");
    ...
    var closer = elmnt.querySelector(".header .closer");
    ...
    var opacer = elmnt.querySelector(".header .opacer");
    ...
    var header = elmnt.querySelector(".header .movable");
    ...
    function elementDrag(e) {
        ...
        pos3 = loc.clientX;
        pos4 = loc.clientY; // set the element's new position:
    ...
    function closeDragElement() {
        ...
        document.ontouchend = null, document.ontouchmove = null, document.onmouseup = null, document.onmousemove = null;
    }
};
